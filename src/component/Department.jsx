...
import img17 from '../imga/img17.jpg'
import img18 from '../imga/img18.jpg'
import img21 from '../imga/img21.jpg'
import img25 from '../imga/img25.jpg'
import img23 from '../imga/img23.jpg'
...
export function Computer(params) {
    const itemData = [
        {
    ...
    return (
        <>
            ...
            <div className="text-center py-5">
                <h1> Computer Engineering     <i class="ms-5 fa-solid fa-graduation-cap fa-beat fa-xl "></i> </h1>
                <br />
...
export function Mechanical(params) {
    const itemData = [
        {
            img: 'https://images.unsplash.com/photo-1549388604-817d15aa0110',
            title: 'Bed',
    ...
    return (
        <>
            ...
            <img src={img17} class="img-fluid w-100 img_computer" alt="..."></img>
   ...
   const itemData = [
    ...
    return (
        <>
            ...
            <img src={img23} class="img-fluid w-100 img_computer" alt="..."></img>
...
export function Electrical(params) {
  const itemData = [
        {
            img: 'https://images.unsplash.com/photo-1549388604-817d15aa0110',
            title: 'Bed',
    ...
    return (
        <>
            ...
            <img src={img18} class="img-fluid w-100 img_computer" alt="..."></img>
...
// ********************************************************************************************************************************************************************************************************************************************************************************************************************************
export function Chemical(params) {
   const itemData = [
        {
            img: 'https://images.unsplash.com/photo-1549388604-817d15aa0110',
            title: 'Bed',
    ...
    return (
        <>
            ...
            <img src={img21} class="img-fluid w-100 img_computer" alt="..."></img>
